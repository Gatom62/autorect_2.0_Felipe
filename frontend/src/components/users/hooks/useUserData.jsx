...
// Normalizamos los datos que nos devuelvera la API
...
const useUserData = () => {
  ...
  const normalizeUser = (apiUser = {}) => ({
    ...
    email: apiUser.email || "",
    userType:
      typeof apiUser.userType === "string"
        ? apiUser.userType.toLowerCase()
        : "usuario",
      ...
      if (!response.ok) {
        ...
        const backendErrors =
          Array.isArray(errors) && errors.length > 0
            ...
            : "";
        throw new Error(
          (message || "Error al registrar el usuario") + backendErrors,
        );
      }
      ...
      if (!response.ok) {
        ...
        const backendErrors =
          Array.isArray(errors) && errors.length > 0
            ...
            : "";
        throw new Error(
          (message || "Error al actualizar el usuario") + backendErrors,
        );
      }
